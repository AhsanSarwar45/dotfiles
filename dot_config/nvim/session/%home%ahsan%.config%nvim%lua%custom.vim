...
badd +1 ~/.config/nvim/lua/custom/highlights.lua
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 30 + 42) / 84)
exe 'vert 2resize ' . ((&columns * 53 + 42) / 84)
argglobal
enew
file NvimTree_1
...
wincmd w
argglobal
balt ~/.config/nvim/lua/custom/highlights.lua
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
